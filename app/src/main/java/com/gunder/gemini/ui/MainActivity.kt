        ...
        setContent {
            GeminiTheme {
                ...
                Surface(
                    ...
                    Scaffold(
                        topBar = { CenterAlignedTopAppBar(title = { Text(text = "Gemini Bot") }) },
                        bottomBar = {
                            Column(
                                modifier = Modifier
                                    .fillMaxWidth()
...
fun ConversationScreen(
    conversations: MutableList<Triple<String, String, List<Bitmap>?>>,
    modifier: Modifier
) {
    ...
    LazyColumn(
        ...
        items(conversations.size) { index ->
            val conversations = conversations[index]
            MessageItem(
                isInComing = conversations.first == "received",
                images = conversations.third ?: emptyList(),
                content = conversations.second,
                modifier = Modifier
                    .fillMaxWidth()
                    .animateItemPlacement()
            )
